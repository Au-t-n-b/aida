...
LEAF_CHAPTERS: tuple[ChapterSpec, ...] = (
    ...
    ChapterSpec("2", "2.设备配置信息.json", "2. 设备配置信息", "ch-02-device-info.json"),
    ...
    ChapterSpec("8.1", "8.1服务交付界面.json", "8.1 服务交付界面", "ch-08-1-service-delivery-ui.json"),
    ChapterSpec("8.2", "8.2服务配置.json", "8.2 服务配置", "ch-08-2-service-content.json"),
    ChapterSpec("8.3", "8.3维保策略.json", "8.3 维保策略", "ch-08-3-maintenance-strategy.json"),
    ChapterSpec("8.4", "8.4维保SLA.json", "8.4 维保SLA", "ch-08-4-maintenance-sla.json"),
