#!/usr/bin/env python3
"""Validate offline NCE planner inputs. Exit code 0=ok, 1=business error, 2=missing deps."""
...
try:
    from nce_planner import PlannerInputs, validate_inputs
except ImportError:
...
from run_nce_planner import _auto_resource, _auto_topology, _require_under_cwd
