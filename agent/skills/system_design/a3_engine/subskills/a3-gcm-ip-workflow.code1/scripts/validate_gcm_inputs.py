#!/usr/bin/env python3
"""校验 GCM（管存面）离线流水线输入 — 可按 --network-plane 指定网络平面。"""
...
from gcm_io_utils import autodetect_007_in_cwd, autodetect_resource_in_cwd, require_under_cwd
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    p = argparse.ArgumentParser(description="Validate inputs for offline GCM pipeline")
    ...
    p.add_argument("--network-plane", default="计算管存面", help="资源表中要匹配的网络平面名称")
