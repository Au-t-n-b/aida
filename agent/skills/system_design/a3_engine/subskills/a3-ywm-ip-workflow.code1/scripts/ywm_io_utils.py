"""007 / 资源表读取：业务面（YWM）离线流程与 dw 流程共用模式，增加服务器名过滤。"""
...
# Align main_flow.file_configs「计算业务面地址规划」→ 计算业务面端口互联
SHEET_007_DEFAULT = "计算业务面端口互联"
SHEET_RES_DEFAULT = "网络资源需求表"
SHEET_RES_DEFAULT_INDEX = SHEET_RES_DEFAULT  # legacy alias
...
def read_resource_row_for_plane(
    ...
    if rows.empty:
        ...
        raise ValueError(
            ...
            f"  - 建议: 修改 --network-plane 或指定 --sheet-res-index / 资源表 sheet「网络资源需求表」。\n"
